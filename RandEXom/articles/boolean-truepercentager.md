# 3.2.1 `TruePercentageR`

[Parent: 3.2 Framework.Boolean](boolean.md) · [Guide map](../index.md)
...
← Previous: [3.2 Framework.Boolean](boolean.md) · [Parent: 3.2 Framework.Boolean](boolean.md) · Next: [3.3 Item](items.md) →
