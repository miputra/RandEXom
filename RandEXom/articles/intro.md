...
For the full public surface, see the [API documentation](../api/index.md). From the repository root, run `dotnet run --project Verification/Verification.csproj` for the library's verification checks.
